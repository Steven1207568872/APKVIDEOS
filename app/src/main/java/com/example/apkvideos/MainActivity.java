...
import com.example.apkvideos.WebServices.Asynchtask;
import com.example.apkvideos.WebServices.WebService;
...
public class MainActivity extends AppCompatActivity implements Asynchtask {
    ...
    public void processFinish(String result) throws JSONException {
        ...
        ArrayList<Video> lstVideos= Video.JsonObjectsBuild(JSONlistaVideos);
